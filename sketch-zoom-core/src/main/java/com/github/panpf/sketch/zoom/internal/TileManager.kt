...
class TileManager constructor(
    ...
    private val subsamplingAbility: SubsamplingAbility,
    ...
    private val bitmapPool: InBitmapHelper = container.inBitmapHelper
    ...
    init {
        logger.d(SubsamplingAbility.MODULE) {
    ...
    fun refreshTiles(previewSize: Size, previewVisibleRect: Rect, drawMatrix: Matrix) {
        ...
        if (tileList == null) {
            logger.w(SubsamplingAbility.MODULE) {
        ...
        subsamplingAbility.invalidateView()
    }
        ...
        canvas.withSave {
            ...
            tileList.forEach { tile ->
                if (tile.srcRect.crossWith(imageLoadRect)) {
                    ...
                    if (subsamplingAbility.showTileBounds) {
    ...
    private fun loadTile(tile: Tile) {
        ...
        tile.loadJob = scope.async(decodeDispatcher) {
            ...
            when {
                bitmap == null -> {
                    logger.e(SubsamplingAbility.MODULE) {
